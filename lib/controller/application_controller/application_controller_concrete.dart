...
import 'package:hire4consult_employ/controller/application_controller/application_controller.dart';
...
class ApplicationControllerConcrete implements ApplicationController {
  ...
  Future<void> submitApplication(String jobId, String userId,
      Map<String, dynamic> jobDetails, Map<String, dynamic> userDetails) async {
