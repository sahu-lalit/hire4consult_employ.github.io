...
import 'package:hire4consult_employ/controller/application_controller/application_controller_concrete.dart';
import 'package:hire4consult_employ/controller/jobs_controller/jobs_controller_concrete.dart';
...
void setupLocator(FirebaseFirestore jobPosterFirestore) {
  ...
  if (!locator.isRegistered<JobsControllerImpl>()) {
    locator
        .registerLazySingleton<JobsControllerImpl>(() => JobsControllerImpl());
  }
